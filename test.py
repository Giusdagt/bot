...
Simula in modo realistico ma controllato il funzionamento del bot di trading.
Verifica inizializzazione, creazione pattern, gestione posizioni, 
addestramento strategie, analisi tecnica e integrazione con gestione del rischio (RM),
senza chiamate reali a MetaTrader5 o API esterne.
Stampa un report dettagliato di cosa è stato testato, funzionamenti ed eventuali anomalie.
"""
import logging
import asyncio
import types
...
sys.modules['joblib'] = types.SimpleNamespace(dump=lambda obj, path: None,
